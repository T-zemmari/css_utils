      ...
      <div className="w-full min-h-screen bg-[#eee] flex justify-center items-center md:items-center">
        <div className="w-full md:max-w-7xl min-h-screen md:min-h-[764px] p-0 md:p-12 ">
          <div className="w-full p-2 min-h-[300px] md:h-[764px] flex justify-center items-center mt-[70px] sm:mt-[50px]">
            <div className="w-full md:h-[100%] lg:h-[90%] flex flex-col md:flex-row md:justify-between lg:items-center gap-8">
              <div
                className="flex w-full md:w-3/6 h-[300px] md:h-[35%] lg:h-[100%] justify-center items-center md:items-start lg:items-center lg:justify-center bg-white rounded-lg"
                id="contenedor_padre_preview"
              >
                <button
                  className="w-40 h-40 bg-white shadow-lg flex justify-center items-center rounded-lg md:mt-10 lg:mt-0"
                  style={{
